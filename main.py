...
class Trainer:
    def __init__(self, config):
        ...
        self.info = f'_n={self.hidden_dimension}_k={self.sum_dimension}_lr={self.lr}'
    ...
    def _plot_results(self):
        ...
        plt.legend()
        plt.title('Loss')
        plt.savefig(f'figs/loss{self.info}.png')
        ...
        plt.legend()
        plt.title('Acc')
        plt.savefig(f'figs/acc{self.info}.png')
    ...
    def plot_scatter_graph(self):
        ...
        plt.savefig(f'figs/scatter{self.info}.png')
    ...
    def plot_target_function(self):
        ...
        plt.savefig(f'figs/target{self.info}.png')
    ...
    def plot_model_output(self):
        ...
        plt.savefig(f'figs/output{self.info}.png')
